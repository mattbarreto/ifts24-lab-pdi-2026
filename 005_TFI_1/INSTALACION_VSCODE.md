...
3. Seleccionar `.venv_005\Scripts\python.exe` en Windows o `.venv_005/bin/python` en macOS/Linux (esta carpeta usa `.venv_005` en vez de `.venv` genérico; ver [INSTALACION_UV.md](INSTALACION_UV.md)).
