...
3. Seleccionar `.venv_006\Scripts\python.exe` en Windows o `.venv_006/bin/python` en macOS/Linux (esta carpeta usa `.venv_006` en vez de `.venv` genérico; ver [INSTALACION_UV.md](INSTALACION_UV.md)).
