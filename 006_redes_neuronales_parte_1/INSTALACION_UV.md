...
Desde la carpeta que contiene este archivo. Esta carpeta usa `.venv_006` en vez de `.venv` genérico (para distinguirla de las demás carpetas del laboratorio), así que primero seteamos esa ruta con la variable `UV_PROJECT_ENVIRONMENT`:
...
Así aparece en el selector de kernel de VS Code/Jupyter como **"PDI 006 - Redes Neuronales 1"**, distinguible de los kernels de las otras carpetas.
