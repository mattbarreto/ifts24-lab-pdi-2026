...
Desde la carpeta que contiene este archivo. Esta carpeta usa `.venv_003` en vez de `.venv` genérico (para distinguirla de las demás carpetas del laboratorio), así que primero seteamos esa ruta con la variable `UV_PROJECT_ENVIRONMENT`:
