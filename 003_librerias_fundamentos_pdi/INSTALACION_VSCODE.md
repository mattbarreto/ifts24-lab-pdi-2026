...
3. Seleccionar `.venv_003\Scripts\python.exe` en Windows o `.venv_003/bin/python` en macOS/Linux (esta carpeta usa `.venv_003` en vez de `.venv` genérico; ver [INSTALACION_UV.md](INSTALACION_UV.md)).
