...
3. Seleccionar `.venv_002a\Scripts\python.exe` en Windows o `.venv_002a/bin/python` en macOS/Linux (esta carpeta usa `.venv_002a` en vez de `.venv` genérico; ver [INSTALACION_UV.md](INSTALACION_UV.md)).
