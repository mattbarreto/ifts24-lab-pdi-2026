...
3. Seleccionar `.venv_008\Scripts\python.exe` en Windows o `.venv_008/bin/python` en macOS/Linux (esta carpeta usa `.venv_008` en vez de `.venv` genérico; ver [INSTALACION_UV.md](INSTALACION_UV.md)).
