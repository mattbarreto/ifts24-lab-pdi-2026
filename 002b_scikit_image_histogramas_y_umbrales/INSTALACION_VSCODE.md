...
3. Seleccionar `.venv_002b\Scripts\python.exe` en Windows o `.venv_002b/bin/python` en macOS/Linux (esta carpeta usa `.venv_002b` en vez de `.venv` genérico; ver [INSTALACION_UV.md](INSTALACION_UV.md)).
