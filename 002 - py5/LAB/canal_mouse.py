#esperar a que se cargue la imagen antes de usarla
#primero va a aparecer el sketch vacio
#luego se carga la imagen de la derecha
#por ultimo, se muestra la imagen de la izquierda con el canal rojo modificado según la posición del mouse
#mover el mouse hacia la derecha aumenta el rojo, hacia la izquierda lo disminuye
#mover el mouse hacia la izquierda lo disminuye
#tarda un ratito en cargar, 
# así que es importante esperar
