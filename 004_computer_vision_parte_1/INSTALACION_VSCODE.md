...
3. Seleccionar `.venv_004\Scripts\python.exe` en Windows o `.venv_004/bin/python` en macOS/Linux (esta carpeta usa `.venv_004` en vez de `.venv` genérico; ver [INSTALACION_UV.md](INSTALACION_UV.md)).
