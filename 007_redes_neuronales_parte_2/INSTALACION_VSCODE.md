...
3. Seleccionar `.venv_007\Scripts\python.exe` en Windows o `.venv_007/bin/python` en macOS/Linux (esta carpeta usa `.venv_007` en vez de `.venv` genérico; ver [INSTALACION_UV.md](INSTALACION_UV.md)).
