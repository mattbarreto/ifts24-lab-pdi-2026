...
3. Seleccionar `.venv_001\Scripts\python.exe` en Windows o `.venv_001/bin/python` en macOS/Linux (esta carpeta usa `.venv_001` en vez de `.venv` genérico; ver [INSTALACION_UV.md](INSTALACION_UV.md)).
